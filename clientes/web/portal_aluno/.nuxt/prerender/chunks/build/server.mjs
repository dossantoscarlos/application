import { version, ref, watchEffect, watch, getCurrentInstance, unref, inject, useSSRContext, createApp, effectScope, reactive, mergeProps, hasInjectionContext, defineAsyncComponent, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, computed, defineComponent, h, isReadonly, isRef, isShallow, isReactive, toRaw } from 'file:///home/nakiban/application/clientes/web/portal_aluno/node_modules/vue/index.mjs';
import { $fetch } from 'file:///home/nakiban/application/clientes/web/portal_aluno/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///home/nakiban/application/clientes/web/portal_aluno/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file:///home/nakiban/application/clientes/web/portal_aluno/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file:///home/nakiban/application/clientes/web/portal_aluno/node_modules/h3/dist/index.mjs';
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL, isEqual, stringifyParsedURL, stringifyQuery, parseQuery } from 'file:///home/nakiban/application/clientes/web/portal_aluno/node_modules/ufo/dist/index.mjs';
import { getActiveHead } from 'file:///home/nakiban/application/clientes/web/portal_aluno/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin, composableNames } from 'file:///home/nakiban/application/clientes/web/portal_aluno/node_modules/@unhead/shared/dist/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///home/nakiban/application/clientes/web/portal_aluno/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Ch2BF1A3.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-MwpSwgLx.mjs').then((r) => r.default || r));
